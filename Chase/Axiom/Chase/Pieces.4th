...
(	{move} eat-nw-1		{move-type} normal-priority
	...
	{move} exchange-5-w	{move-type} normal-priority
	{move} exchange-5-e	{move-type} normal-priority
	{move} Pass		{move-type} normal-priority
moves}
...
{pieces
	{piece}		q6	{moves} q-moves 1   {value}
	{piece}		q5	{moves} q-moves 2   {value}
	{piece}		q4	{moves} q-moves 3   {value}
	{piece}		q3	{moves} q-moves 4   {value}
	{piece}		q2	{moves} q-moves 5   {value}
	{piece}		q1	{moves} q-moves 6   {value}
